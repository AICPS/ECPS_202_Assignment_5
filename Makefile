...
pkgdatadir = $(datadir)/matiec
pkgincludedir = $(includedir)/matiec
pkglibdir = $(libdir)/matiec
pkglibexecdir = $(libexecdir)/matiec
...
am__DIST_COMMON = $(srcdir)/Makefile.in $(srcdir)/common.mk \
	$(top_srcdir)/config/compile $(top_srcdir)/config/config.h.in \
	$(top_srcdir)/config/depcomp $(top_srcdir)/config/install-sh \
	$(top_srcdir)/config/missing COPYING INSTALL config/INSTALL \
...
OBJEXT = o
PACKAGE = matiec
PACKAGE_BUGREPORT = msousa@fe.up.pt, beremiz-devel@lists.sourceforge.net
PACKAGE_NAME = matiec
PACKAGE_STRING = matiec 0.1
PACKAGE_TARNAME = matiec
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
RANLIB = ranlib
...
YACC = bison -y
YFLAGS = 
abs_builddir = /media/data2/yonatan/matiec
abs_srcdir = /media/data2/yonatan/matiec
abs_top_builddir = /media/data2/yonatan/matiec
abs_top_srcdir = /media/data2/yonatan/matiec
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /media/data2/yonatan/matiec/config/install-sh
...
iec2c$(EXEEXT): $(iec2c_OBJECTS) $(iec2c_DEPENDENCIES) $(EXTRA_iec2c_DEPENDENCIES) 
	@rm -f iec2c$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(iec2c_OBJECTS) $(iec2c_LDADD) $(LIBS)

iec2iec$(EXEEXT): $(iec2iec_OBJECTS) $(iec2iec_DEPENDENCIES) $(EXTRA_iec2iec_DEPENDENCIES) 
	@rm -f iec2iec$(EXEEXT)
	$(AM_V_CXXLD)$(CXXLINK) $(iec2iec_OBJECTS) $(iec2iec_LDADD) $(LIBS)
